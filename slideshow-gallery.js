function SlideshowGallery(canvasId, images, options={}){
    ...
    this.clickAction = function(obj,event){
        ...
        if(x >= this.options.width-(obj.rightButtonImage.width) && x <= this.options.width && y >= (this.options.height/2) - (obj.rightButtonImage.height/2) && y <= (this.options.height/2) + (obj.rightButtonImage.height/2)){
            this.nextPhoto();
        }
    }
    ...
    this.draw = function(obj){
        ...
        obj.ctx.fillRect(0, 448, obj.options.width * (obj.autoPhotoGalleryTimer/obj.options.autoPhotoGalleryTimer), 450);
        obj.ctx.stroke();
    ...
    this.photoGalleryInterval = function(){
        if(this.options.autoPhotoGalleryTimer > 0 && this.moveAnimation.enabled == false){
            this.autoPhotoGalleryTimer+=10;
            if(this.autoPhotoGalleryTimer >= this.options.autoPhotoGalleryTimer){
                this.nextPhoto();
            }
        } 
    ...
    this.init = function(){
        ...
        this.leftButtonImage.src = this.options.leftButtonImageSource;
        ...
        this.rightButtonImage.src = this.options.rightButtonImageSource;
        ...
        this.canvasElement.addEventListener('mousedown', (e) => this.clickAction(this,e))
    }
